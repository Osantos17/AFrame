          ...
          <div className="border-t border-gray-400 w-10 ml-0"></div>
            ...
            <div className="windContainer flex flex-col items-center">
              ...
              <div className="Wind flex flex-col items-center">
                <div className="windSpeed mt-[-3px] text-white pt-1">{item.windspeedMiles || 'N/A'}</div>
              ...
              <div className="windLogo flex flex-col items-center mt-1">
                <img
                  src={
                    item.windspeedMiles < 5
                      ? './src/Images/GreenWindArrow.png'
                      : item.windspeedMiles <= 8
                  ...
                  alt="Wind Arrow"
                  style={{
                    transform: `rotate(${(item.winddirDegree + 180) % 360}deg)`,
                  }}
                />
              </div>
              <div className="windDirection degrees text-gray-500 mt-1">{item.winddirDegree || 'N/A'}</div>
              <div className="pointDirection">{item.winddir16point || 'N/A'}</div>
